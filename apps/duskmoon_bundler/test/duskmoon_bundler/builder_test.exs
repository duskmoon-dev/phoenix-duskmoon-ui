defmodule DuskmoonBundler.BuilderTest do
  ...
  describe "build/1" do
    ...
    test "uses configured env prefix" do
      ...
      console.log(import.meta.env.DUSKMOON_BUNDLER_API)
      """)
      ...
      try do
        ...
        refute js =~ "http://duskmoon_bundler.test"
      after
    ...
    test "bundles Svelte components with runtime package resolution" do
      ...
      <script>
        export let name = 'DuskmoonBundler'
      </script>
    ...
    test "bundles Solid TSX through configured plugin" do
      ...
      render(() => <App name="DuskmoonBundler" />)
      """)
    ...
    test "dynamic import protection avoids user identifier collisions" do
      ...
      function __duskmoon_bundler_dynamic_import__0__(value: string) {
        return value
      }

      document.body.dataset.placeholder = __duskmoon_bundler_dynamic_import__0__('kept')
      ...
      assert entry_js =~ "function __duskmoon_bundler_dynamic_import__0__"
