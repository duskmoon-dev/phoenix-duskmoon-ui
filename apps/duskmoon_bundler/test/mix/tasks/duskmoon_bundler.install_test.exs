defmodule DuskmoonBundler.InstallTest do
  use ExUnit.Case

  alias Igniter.Test

  describe "duskmoon_bundler.install" do
    test "removes esbuild and tailwind config and updates aliases" do
      igniter =
        ...
        |> Mix.Tasks.DuskmoonBundler.Install.igniter()
      ...
      assert dev_content =~ "duskmoon_bundler:"
      ...
      assert mix_content =~
               ~s("assets.deploy": ["duskmoon_bundler.build --tailwind", "phx.digest"])
    end
  end
end
