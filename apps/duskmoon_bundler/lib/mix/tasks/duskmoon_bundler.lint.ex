defmodule Mix.Tasks.DuskmoonBundler.Lint do
  ...
  Configure lint settings in `config :duskmoon_bundler, :lint`:
  ...
  def run(args) do
    ...
    files = DuskmoonBundler.JS.Helpers.discover_files(only: ~w(.js .ts .jsx .tsx))
