defmodule DuskmoonBundler.JS.TSConfig do
  @moduledoc """
  Read `compilerOptions.paths` from `tsconfig.json` and convert to DuskmoonBundler aliases.

  Automatically discovers `tsconfig.json` in the project root and maps
  TypeScript path aliases (e.g. `"@/*": ["./src/*"]`) to the format
  DuskmoonBundler's resolver expects.
  """
