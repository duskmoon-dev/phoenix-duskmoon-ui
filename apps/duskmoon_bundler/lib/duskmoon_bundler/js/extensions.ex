defmodule DuskmoonBundler.JS.Extensions do
  @moduledoc "JavaScript, TypeScript, CSS, and asset extension groups used by DuskmoonBundler."
  ...
  defp plugin_exts(plugins, kind) do
    DuskmoonBundler.PluginRunner.extensions(plugins, kind)
  end
end
