defmodule DuskmoonBundler.Plugin do
  @moduledoc """
  Behaviour for DuskmoonBundler build plugins.
  ...
  plugin defines a callback with one extra arity, DuskmoonBundler passes the tuple opts as
  the final argument.
  ...
  DuskmoonBundler's normal JavaScript parser before plugin processing, such as component
  files or custom markup formats. Return `nil` to let DuskmoonBundler use the default
  JavaScript import extractor.
  """
  @callback extract_imports(path :: String.t(), source :: String.t(), opts :: keyword()) ::
              {:ok, DuskmoonBundler.JS.ImportExtractor.Result.t()} | {:error, term()} | nil
  ...
  This is DuskmoonBundler-specific. Vite framework plugins achieve similar results through
  ...
  @type prebundle_import :: DuskmoonBundler.JS.PrebundleEntry.Import.t()
  @type prebundle_export :: DuskmoonBundler.JS.PrebundleEntry.Export.t()
  ...
  package exports for browser dev mode. Return `nil` to let DuskmoonBundler generate a
