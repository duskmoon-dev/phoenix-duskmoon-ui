defmodule PhoenixDuskmoon.CssArt.SpotlightSearch do
  @moduledoc """
  ...
  ## Examples
      ...
      <.dm_art_spotlight_search id="global-search">
  ...
  * `:suggestion` - Search suggestions with icon, label, and optional action
  ...
  def dm_art_spotlight_search(assigns) do
    ~H"""
    <dialog
      id={@id}
      open={@open}
    ...
    >
      <div class="modal-box p-0">
        <div class="dm-art-spotlight-input">
          ...
          />
          <div :if={@loading} class="dm-art-spotlight-loading"></div>
          <button
            :if={!@loading}
            type="button"
