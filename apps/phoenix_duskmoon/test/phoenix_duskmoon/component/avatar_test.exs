defmodule PhoenixDuskmoon.Component.AvatarTest do
  ...
  test "renders avatar with image" do
    ...
    assert result =~ ~s[<img src="https://example.com/avatar.jpg" alt="User Avatar" class="w-full h-full object-cover ]
  end
  ...
  test "renders avatar with placeholder image" do
    ...
    assert result =~ ~s[<img src="/path/to/placeholder.jpg" alt="Placeholder" class="w-full h-full object-cover">]
  end
