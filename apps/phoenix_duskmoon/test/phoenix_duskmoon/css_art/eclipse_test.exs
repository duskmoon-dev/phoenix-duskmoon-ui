defmodule PhoenixDuskmoon.CssArt.EclipseTest do
  ...
  test "renders eclipse with required id" do
    ...
    assert result =~ "dm-art-eclipse"
    assert result =~ ~s[id="eclipse-1"]
  end

  test "renders eclipse with 6 animation layers" do
    result = render_component(&dm_art_eclipse/1, %{id: "eclipse-2"})
  ...
  test "renders eclipse with dm-art-eclipse class for all sizes" do
    for size <- ~w(small medium large) do
      result = render_component(&dm_art_eclipse/1, %{id: "e", size: size})
      assert result =~ "dm-art-eclipse"
    end
  end

  test "renders eclipse with style attribute containing CSS variables" do
    result = render_component(&dm_art_eclipse/1, %{id: "e"})
  ...
  test "renders eclipse with faster animation speed" do
    result = render_component(&dm_art_eclipse/1, %{id: "e", animation_speed: 2.0})
  ...
  test "renders eclipse with slower animation speed" do
    result = render_component(&dm_art_eclipse/1, %{id: "e", animation_speed: 0.5})
  ...
  test "renders eclipse with custom bg_color in CSS variable" do
    result = render_component(&dm_art_eclipse/1, %{id: "e", bg_color: "#1a1a2e"})
  ...
  test "renders eclipse animation durations proportional to speed 4.0" do
    result = render_component(&dm_art_eclipse/1, %{id: "e", animation_speed: 4.0})
  ...
  test "renders eclipse with very slow animation speed 0.25" do
    result = render_component(&dm_art_eclipse/1, %{id: "e", animation_speed: 0.25})
  ...
  test "renders eclipse with small size" do
    result = render_component(&dm_art_eclipse/1, %{id: "e", size: "small"})
  ...
  test "renders eclipse with fractional animation speed rounding" do
    ...
    result = render_component(&dm_art_eclipse/1, %{id: "e", animation_speed: 3.0})
  ...
  test "renders eclipse with animation_speed 0.0 without crashing" do
    result = render_component(&dm_art_eclipse/1, %{id: "e-zero", animation_speed: 0.0})
  ...
  test "renders eclipse with animation_speed 0.0 clamped to 0.01" do
    result = render_component(&dm_art_eclipse/1, %{id: "e-clamp", animation_speed: 0.0})
  ...
  test "renders eclipse with animation_speed 1.0 is the default" do
    result = render_component(&dm_art_eclipse/1, %{id: "e-default"})

    # Default speed 1.0
    assert result =~ "animation-duration: 30s"
  end

  test "renders eclipse outer div with dm-art-eclipse class" do
    result = render_component(&dm_art_eclipse/1, %{id: "e-outer"})

    # The outermost div should have the dm-art-eclipse class
    assert result =~ ~s[class="dm-art-eclipse]
  end

  test "renders eclipse with negative animation_speed clamped to 0.01" do
    result = render_component(&dm_art_eclipse/1, %{id: "e-neg", animation_speed: -1.0})
  ...
  test "renders eclipse with each layer having distinct animation HTML comments" do
    result = render_component(&dm_art_eclipse/1, %{id: "e-comments"})
  ...
  test "renders eclipse with id attribute on outer div" do
    result = render_component(&dm_art_eclipse/1, %{id: "eclipse-id-test"})

    assert result =~ ~s[id="eclipse-id-test"]
  end

  test "renders eclipse with aria-hidden for decorative content" do
    result = render_component(&dm_art_eclipse/1, %{id: "eclipse-a11y"})
