defmodule PhoenixDuskmoon.CssArt.PlasmaBallTest do
  ...
  test "renders plasma ball with glass ball structure" do
    result = render_component(&dm_art_plasma_ball/1, %{id: "plasma-2"})
  ...
  test "renders plasma ball with base structure" do
    result = render_component(&dm_art_plasma_ball/1, %{id: "plasma-3"})

    assert result =~ ~s[class="base"]
  end

  test "renders plasma ball with switch toggle" do
    result = render_component(&dm_art_plasma_ball/1, %{id: "plasma-4"})
  ...
  test "renders plasma ball without electrode when show_electrode is false" do
    result = render_component(&dm_art_plasma_ball/1, %{id: "plasma-9", show_electrode: false})

    assert result =~ "hide-electrode"
  end

  test "renders plasma ball with phx-click event" do
    result = render_component(&dm_art_plasma_ball/1, %{id: "plasma-10"})

    assert result =~ ~s[phx-click="plasma_toggle"]
  end

  test "renders plasma ball with custom class" do
    result = render_component(&dm_art_plasma_ball/1, %{id: "plasma-11", class: "my-plasma"})
  ...
  test "renders plasma ball with multiple ray groups" do
    result = render_component(&dm_art_plasma_ball/1, %{id: "plasma-12"})
  ...
  test "renders plasma ball with correct size pixel values for each preset" do
    for {size, expected_px} <- [{"small", "250"}, {"medium", "350"}, {"large", "450"}] do
      result = render_component(&dm_art_plasma_ball/1, %{id: "plasma-sz", size: size})
  ...
  test "renders plasma ball with custom base_color in CSS variable" do
    result = render_component(&dm_art_plasma_ball/1, %{id: "plasma-sv", base_color: "#1a1a2e"})
    assert result =~ "--base-color: #1a1a2e"
  end

  test "renders plasma ball with 4 ray groups" do
    result = render_component(&dm_art_plasma_ball/1, %{id: "plasma-rg"})
  ...
  test "renders plasma ball with bigwave rays" do
    result = render_component(&dm_art_plasma_ball/1, %{id: "plasma-rr"})
  ...
  test "renders plasma ball with default medium size" do
    result = render_component(&dm_art_plasma_ball/1, %{id: "plasma-def"})

    assert result =~ "--size: 350px"
  end

  test "renders plasma ball with style attribute" do
    result = render_component(&dm_art_plasma_ball/1, %{id: "plasma-style"})
  ...
  test "renders plasma ball show_electrode true by default" do
    result = render_component(&dm_art_plasma_ball/1, %{id: "plasma-elec"})
  ...
  test "renders plasma ball with custom base_color" do
    result =
      render_component(&dm_art_plasma_ball/1, %{id: "plasma-bc", base_color: "#ff0000"})

    assert result =~ "--base-color: #ff0000"
  end

  test "renders plasma ball with 5 rays per group" do
    result = render_component(&dm_art_plasma_ball/1, %{id: "plasma-rays5"})
  ...
  test "renders plasma ball checkbox input for toggle" do
    result = render_component(&dm_art_plasma_ball/1, %{id: "plasma-chk"})
  ...
  test "renders plasma ball with nil phx_target omits phx-target" do
    result = render_component(&dm_art_plasma_ball/1, %{id: "plasma-notgt", phx_target: nil})
  ...
  test "renders plasma ball electrode without hide class when show_electrode true" do
    result = render_component(&dm_art_plasma_ball/1, %{id: "plasma-show-e", show_electrode: true})
  ...
  test "renders plasma ball checkbox with aria-label for toggle" do
    result = render_component(&dm_art_plasma_ball/1, %{id: "plasma-a11y"})

    assert result =~ ~s[aria-label="Toggle plasma effect"]
  end

  test "renders plasma ball wrapper div with id" do
    result = render_component(&dm_art_plasma_ball/1, %{id: "my-plasma"})

    assert result =~ ~s[id="my-plasma"]
  end

  test "renders plasma ball with dm-art-plasma-ball class" do
    result = render_component(&dm_art_plasma_ball/1, %{id: "plasma-cls"})
