defmodule PhoenixDuskmoon.CssArt.SnowTest do
  ...
  test "renders default 30 snowflakes" do
    result = render_component(&dm_art_snow/1, %{id: "snow-2"})
  ...
  test "renders custom number of snowflakes" do
    result = render_component(&dm_art_snow/1, %{id: "snow-3", count: 10})
  ...
  test "renders snow with snowfall animation keyframes" do
    result = render_component(&dm_art_snow/1, %{id: "snow-10"})

    assert result =~ "<style>"
    assert result =~ "@keyframes snowfall"
    assert result =~ "dm-art-snowflake"
  end
  ...
  test "renders snow with count of 1" do
    result = render_component(&dm_art_snow/1, %{id: "snow-one", count: 1})
  ...
  test "renders snowflakes with animation-duration in style" do
    result = render_component(&dm_art_snow/1, %{id: "snow-dur"})

    assert result =~ "animation-duration:"
  end

  test "renders snowflakes with animation-delay in style" do
    result = render_component(&dm_art_snow/1, %{id: "snow-delay"})

    assert result =~ "animation-delay:"
  end

  test "renders snowflakes with left positioning" do
    result = render_component(&dm_art_snow/1, %{id: "snow-left"})

    assert result =~ "left:"
  end

  test "renders snow with swaying animation keyframes" do
    result = render_component(&dm_art_snow/1, %{id: "snow-sway"})
  ...
  test "renders snow with custom size_range" do
    result = render_component(&dm_art_snow/1, %{id: "snow-sz", count: 5, size_range: {10, 30}})
  ...
  test "renders snow with count 0 without crashing" do
    result = render_component(&dm_art_snow/1, %{id: "snow-zero", count: 0})
  ...
  test "renders snow container with overflow-hidden" do
    result = render_component(&dm_art_snow/1, %{id: "snow-overflow"})

    assert result =~ "overflow-hidden"
  end

  test "renders no snowflakes with negative count" do
    result = render_component(&dm_art_snow/1, %{id: "snow-neg", count: -5})
  ...
  test "renders snowflakes with use_unicode false explicitly" do
    result = render_component(&dm_art_snow/1, %{id: "snow-no-uni", use_unicode: false, count: 3})
  ...
  test "renders style block even with count 0" do
    result = render_component(&dm_art_snow/1, %{id: "snow-style-zero", count: 0})
  ...
  test "renders snowflake color in inline style" do
    result = render_component(&dm_art_snow/1, %{id: "snow-clr", count: 1, color: "#AABB00"})

    assert result =~ "--snowflake-color: #AABB00"
  end

  test "renders snowflakes with dm-art-snowflake class" do
    result = render_component(&dm_art_snow/1, %{id: "snow-cls", count: 2})

    # Each snowflake div should have the dm-art-snowflake class
    flake_count = length(String.split(result, "dm-art-snowflake")) - 1
  ...
  test "renders snow odd/even swaying keyframes" do
    result = render_component(&dm_art_snow/1, %{id: "snow-sway2"})
  ...
  test "renders snowflake position absolute in style block" do
    result = render_component(&dm_art_snow/1, %{id: "snow-pos"})
  ...
  test "renders snow container with aria-hidden for decorative content" do
    result = render_component(&dm_art_snow/1, %{id: "snow-a11y"})
