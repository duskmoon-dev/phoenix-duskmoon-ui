defmodule PhoenixDuskmoon.CssArt.ButtonNoiseTest do
  ...
  test "renders button noise with required attrs" do
    result =
      render_component(&dm_art_button_noise/1, %{
        id: "noise-1",
        content: "Click me"
      })
  ...
  test "renders exactly 72 light bars" do
    result =
      render_component(&dm_art_button_noise/1, %{id: "noise-exact", content: "Test"})
