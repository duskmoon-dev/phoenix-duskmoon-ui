{
  inputs =
    let
      version = "1.8.2";
system = "x86_64-linux";
devenv_root = "/home/coder/Workspace/gsmlg-dev/phoenix-duskmoon-ui";
devenv_dotfile = "/home/coder/Workspace/gsmlg-dev/phoenix-duskmoon-ui/.devenv";
devenv_dotfile_path = ./.devenv;
devenv_tmpdir = "/tmp";
devenv_runtime = "/tmp/devenv-f11ad0b";
